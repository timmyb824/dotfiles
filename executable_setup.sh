...
install_op_cli_macos() {
	...
	local op_cli_pkg="op_apple_universal_v${ONEPASSWORD_VERSION}.pkg"
	$download_cmd "$op_cli_pkg" "https://cache.agilebits.com/dist/1P/op2/pkg/v${ONEPASSWORD_VERSION}/$op_cli_pkg"
